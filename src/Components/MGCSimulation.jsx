...
import GraphAnalytics from './GraphAnalytics.jsx';
...
const MGCSimulation = () => {
    ...
    const handleSubmit = (e) => {
        ...
        console.log("res", res);
        setRow(res);
        setShowTable(true); // Show the table once the data is processed
    }
    ...
    return (
        <>
            {showsecondform && (
                <>
                    <form className="w-full max-w-sm bg-gray-100 p-4 rounded shadow-md">
                        ...
                        <div className="mb-4">
                            <label htmlFor="NumberofServer" className="block text-gray-700 text-sm font-bold mb-2">
                                Number of Servers
                            </label>
                            <input
                                type="number"
                            ...
                            <Table sx={{ minWidth: 700 }} aria-label="customized table">
                                <TableHead>
                                    <TableRow>
                                        ...
                                        {row?.length !== 0 && row?.priority?.length !== 0 && (
                                ...
                                <div className="flex flex-wrap items-center justify-center w-full">
                                    {row?.ganttCharts?.length !== 0 ? (
                                        row?.ganttCharts?.map((chart, chartIndex) => (
                                            <div key={chartIndex} className="gantt-chart-section my-2 flex flex-col w-full ">
                                                ...
                                                <div className="flex flex-wrap md:justify-start justify-center">
                                                    {chart.map((item, index) => {
                                                        ...
                                                        const idleTime = nextItem && nextItem.start_Time > item.end_Time
            ...
            {/* Pass row data to GraphAnalytics */}
            <GraphAnalytics row={row} />
        </>
    );
}
